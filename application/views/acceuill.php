...
<a href="<?php echo base_url('SocieteController/voir_de'); ?>"  class="btn btn-primary">Voir devis d'equivalence</a>
<a href="<?php echo base_url('SocieteController/ajouter_equivalence'); ?>"  class="btn btn-primary">Mettre a jour l'equivalence</a>
   
<br>

        <?php foreach($listoObjectif->result_array() as $rows) {?>
