...
<style>    public function insertRegimeMenuMatinMidiSoir($nomregime,$idmenuMatin,$idmenuMidi,$idmenuSoir,$idmenuGouter,$pourcentageMatin,$pourcentageMidi,$pourcentageSoir,$pourcentageGouter,$calorie,$activite){
        ...
        $minute = random_int(5,20);
        
        $sqlRegimeActivite = "insert into regimeactivite values (default,".$idRegime.",100,".$activite.",".$minute.",".$calorie.")";
