...
function randomColor() {
	// Génération d'une valeur hexadécimale aléatoire pour chaque composante de couleur (rouge, vert, bleu)
	...
	// Concaténation des composantes de couleur en une chaîne hexadécimale complète
	var hexColor = "#" + red + green + blue;
  
	// Retour de la chaîne hexadécimale
	return hexColor;
  }
  function randomColorsArray(length) {
	var colors = [];
